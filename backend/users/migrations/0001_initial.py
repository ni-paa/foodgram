    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Обязательное поле', max_length=150, unique=True, validators=[django.core.validators.RegexValidator(message='Неверный формат Никнейма.', regex='^[\\w.@+-]+$'), users.validators.validate_username], verbose_name='Никнейм')),
